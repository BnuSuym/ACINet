...
class McDD(nn.Module):
    def __init__(self):
        ...
        self.cau1 = CAU(512, 512, 320)
        self.cau2 = CAU(512, 320, 128)
        self.cau3 = CAU(320, 128, 64)
        self.cau4 = CAU(128, 64, 64)
        self.pcu1 = PCU(512)
        self.pcu2 = PCU(320)
        self.pcu3 = PCU(128)
        self.pcu4 = PCU(64)
    ...
    def forward(self, x1, x2, x3, x4):  # x1 x2 x3 x4 为融合特征 从高级到低级
        fuse1 = self.cau1(in1=x1, in3=x2)
        fuse2 = self.cau2(in1=x2, in2=x1, in3=x3)
        fuse3 = self.cau3(in1=x3, in2=x2, in3=x4)
        fuse4 = self.cau4(in1=x4, in2=x3)
        ...
        de2_1 = self.delayer_4(self.pcu1(fuse1, sal_att1))
        de2_2 = self.delayer_5(self.pcu2(de1_2, sal_att2) + de2_1)
        de2_3 = self.delayer_6(self.pcu3(de1_3, sal_att3) + de2_2)
        sal_out2 = self.prelayer2(self.pcu4(de1_4, sal_att4) + de2_3)
